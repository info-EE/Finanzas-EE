document.addEventListener('DOMContentLoaded', () => {
    ...
    const App = {
        ...
        // ... (el resto de las funciones de JavaScript van aquí, desde renderAeatSettings hasta el final) ...
        ...
        handleTransferFormSubmit(e) {
            ...
            if (fromAccount.currency !== toAccount.currency) {
                ...
                if (isNaN(amountReceived) || amountReceived <= 0) {
                    this.showAlertModal('Monto Requerido', 'Debe especificar un monto recibido válido y mayor que cero para transferencias entre distintas monedas.'); return;
                }
        ...
        handleAddAccount(e) {
            ...
            if (this.state.accounts.some(acc => acc.name === name)) {
                this.showAlertModal('Cuenta Duplicada', 'Ya existe una cuenta con este nombre.'); return;
            }
