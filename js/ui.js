...
function renderTransactions() { // Lógica de búsqueda necesita adaptarse si se quiere buscar por nombre de cuenta
    ...
    console.log('[renderTransactions] Rendering with accounts:', accounts); // Log para depuración
    // Añadir chequeos robustos
...
export function showConfirmationModal(title, message, onConfirm) {
    ...
    const confirmHandler = () => {
        ...
        newConfirmBtn.removeEventListener('click', confirmHandler); // Use removeEventListener on the cloned button
    };
    ...
    cancelBtn.onclick = () => modal.classList.add('hidden'); // Simple assignment is fine for cancel
