...
export function bindEventListeners() {
    ...
    elements.facturaAddItemBtn.addEventListener('click', () => {
        ...
        itemDiv.innerHTML = `
            ...
            <div class="col-span-2"><input type="number" value="1" min="0.01" step="0.001" class="form-input item-quantity" required></div>
            <div class="col-span-3"><input type="number" min="0" step="0.001" class="form-input item-price" required></div>
